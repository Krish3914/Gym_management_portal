...
export const Notifications = () => {
  ...
  return user.length > 0 ? (
      ...
      <table className="mx-auto border-collapse border rounded-lg overflow-hidden shadow-lg bg-gradient-to-r from-blue-500 to-purple-500 text-white">
        <thead>
    ...
    <span className="mx-auto text-center block text-lg font-semibold mt-8 bg-purple-200 text-purple-500 py-2 px-4 border border-purple-200 rounded shadow-md">
