...
import heroBackground from "../images/img/breadcrumb/classes-breadcrumb.jpg"
            ...
            <div className="row classes-slider owl-carousel">
                <div className="col-lg-4">
                    ...
                    <div className="single-class-item set-bg" data-setbg="img/classes/classes-4.jpg">
                        <div className="si-text">
                            <h4>Karate</h4>
                            <span><i className="fa fa-user"></i> Kevin McCormick</span>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4">
                    <div className="single-class-item set-bg" data-setbg="img/classes/classes-2.jpg">
                        <div className="si-text">
                            <h4>Running</h4>
                            <span><i className="fa fa-user"></i> Randy Rivera</span>
                        </div>
                    </div>
                    <div className="single-class-item set-bg" data-setbg="img/classes/classes-5.jpg">
                        <div className="si-text">
                            <h4>Dance</h4>
                            <span><i className="fa fa-user"></i> Russell Lane</span>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4">
